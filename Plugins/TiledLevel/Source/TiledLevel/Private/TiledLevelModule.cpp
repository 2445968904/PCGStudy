...
#include "AutoPaintRuleEditor/AutoPaintRuleDetailCustomization.h"
#include "AutoPaintRuleEditor/AutoPaintRuleTypeActions.h"
...
void FTiledLevelModule::StartupModule()
{
	...
	PropertyModule.RegisterCustomClassLayout(
		UAutoPaintItemRule::StaticClass()->GetFName(),
		FOnGetDetailCustomizationInstance::CreateStatic(FAutoPaintRuleDetailCustomization::MakeInstance)
		);
    ...
    PropertyModule.RegisterCustomPropertyTypeLayout(
        FName(TEXT("TiledItemObj")),
        FOnGetPropertyTypeCustomizationInstance::CreateStatic(&FTiledItemObjDetails::MakeInstance)
        );
	...
	TSharedRef<IAssetTypeActions> AutoPaintRuleActions = MakeShareable(new FAutoPaintRuleTypeActions(TiledLevelAssetCategory));
	AssetTools.RegisterAssetTypeActions(TiledLevelAssetActions);
	AssetTools.RegisterAssetTypeActions(TiledItemSetActions);
	AssetTools.RegisterAssetTypeActions(AutoPaintRuleActions);
	CreatedAssetTypeActions.Add(TiledLevelAssetActions);
	CreatedAssetTypeActions.Add(TiledItemSetActions);
	CreatedAssetTypeActions.Add(AutoPaintRuleActions);


	// register thumbnail renderer 缩略图
...
void FTiledLevelModule::ShutdownModule()
{
	...
	if (FModuleManager::Get().IsModuleLoaded("PropertyEditor"))
	{
		...
		PropertyModule.UnregisterCustomClassLayout(UAutoPaintItemRule::StaticClass()->GetFName());
		PropertyModule.UnregisterCustomPropertyTypeLayout("TemplateAsset");
