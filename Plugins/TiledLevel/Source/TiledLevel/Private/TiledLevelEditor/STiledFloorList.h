...
// This notify hook is useless? Why it even exists?
// class FNotifyHook;
...
public:
	...
	void Construct(const FArguments& InArgs, UTiledLevelAsset* InTiledLevel, TSharedPtr<class FUICommandList> InParentCommandList );
...
private:
	...
	void ClearNormalInstances() const;
	void ClearAutoInstances() const;
