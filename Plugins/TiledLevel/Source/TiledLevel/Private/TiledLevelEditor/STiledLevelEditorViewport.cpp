...
{
	EditorViewportClient = MakeShareable(new FTiledLevelViewportClient(TiledLevelEditorPtr, SharedThis(this),
		*PreviewScene, TiledLevelEditorPtr.Pin().Get()->GetTiledLevelBeingEdited()));
