...
public:
    ...
    void InitTiledItemSetEditor(const EToolkitMode::Type Mode, const TSharedPtr<class IToolkitHost>& InitToolkitHost,
                                class UTiledItemSet* InItemSet);
...
private:
    UTiledItemSet* TiledItemSetBeingEdited; // use raw pointer looks really bad... but it works fine? so just let it be?
    ...
    void UpdatePreviewMeshInEditor(UTiledLevelItem* Item);
};
