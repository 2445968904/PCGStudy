...
//	Level Editing
	...
	// V3.0
	TSharedPtr<FUICommandInfo> ToggleAutoPaint;
	TSharedPtr<FUICommandInfo> RespawnAutoPaintInstances;
	TSharedPtr<FUICommandInfo> ToggleAutoPaintItemHint;
	TSharedPtr<FUICommandInfo> ToggleEditViewMode;
	TSharedPtr<FUICommandInfo> CreateNewRuleItem;
	TSharedPtr<FUICommandInfo> CreateNewRuleGroup;
