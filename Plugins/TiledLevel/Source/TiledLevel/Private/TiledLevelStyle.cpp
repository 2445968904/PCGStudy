...
TSharedRef< FSlateStyleSet > FTiledLevelStyle::Create()
{
	...
	Style->Set("ClassIcon.AutoPaintRule", new IMAGE_BRUSH(TEXT("Class_AutoPaintRule_128x"), Icon16x16));
	Style->Set("ClassThumbnail.AutoPaintRule", new IMAGE_BRUSH(TEXT("Class_AutoPaintRule_128x"), Icon128x128));
	...
	Style->Set("TiledLevel.Eraser", new IMAGE_BRUSH(TEXT("EraserTool_128x"), Icon20x20));
	Style->Set("TiledLevel.Eraser.Small", new IMAGE_BRUSH(TEXT("EraserTool_128x"), Icon20x20));
	...
	Style->Set("TiledLevel.ToggleAutoPaint", new IMAGE_BRUSH(TEXT("Class_AutoPaintRule_128x"), Icon40x40));
	Style->Set("TiledLevel.ToggleAutoPaint.Small", new IMAGE_BRUSH(TEXT("Class_AutoPaintRule_128x"), Icon40x40));
	...
	constexpr FLinearColor FloorSelectionColor = FLinearColor(0.13f, 0.70f, 1.00f);
	const FTableRowStyle& NormalTableRowStyle = FAppStyle::Get().GetWidgetStyle<FTableRowStyle>("TableView.Row");
	Style->Set("TiledLevel.FloorBrowser.TableViewRow",
		 FTableRowStyle(NormalTableRowStyle)
		 .SetActiveBrush(IMAGE_BRUSH("Selection", Icon8x8, FloorSelectionColor))
		 .SetActiveHoveredBrush(IMAGE_BRUSH("Selection", Icon8x8, FloorSelectionColor))
		 .SetInactiveBrush(IMAGE_BRUSH("Selection", Icon8x8, FloorSelectionColor))
		 .SetInactiveHoveredBrush(IMAGE_BRUSH("Selection", Icon8x8, FloorSelectionColor))
		 );
	
	Style->Set("TiledLevel.FloorBrowser.SelectionColor", FloorSelectionColor);

	// 3.0 styles

	Style->Set("TiledLevel.Any", new IMAGE_BRUSH(TEXT("MaterialDesignIcons/Any"), Icon24x24));
	Style->Set("TiledLevel.Negative", new IMAGE_BRUSH(TEXT("MaterialDesignIcons/Negative"), Icon24x24));

	
	FCheckBoxStyle DefaultCheckBoxStyle = FCoreStyle::Get().GetWidgetStyle<FCheckBoxStyle>("Checkbox");
	DefaultCheckBoxStyle.UncheckedImage.SetImageSize(Icon24x24);
	DefaultCheckBoxStyle.UncheckedHoveredImage.SetImageSize(Icon24x24);
	DefaultCheckBoxStyle.UncheckedPressedImage.SetImageSize(Icon24x24);

	Style->Set("TiledLevel.EnableRuleCheckbox",
		FCheckBoxStyle(DefaultCheckBoxStyle)
		.SetCheckedImage(IMAGE_BRUSH("MaterialDesignIcons/Check", Icon24x24))
		.SetCheckedHoveredImage(IMAGE_BRUSH("MaterialDesignIcons/Check", Icon24x24, FLinearColor(0.5f, 0.5f, 0.5f)))
		.SetCheckedPressedImage(IMAGE_BRUSH("MaterialDesignIcons/Check", Icon24x24, FLinearColor(0.2f, 0.2f, 0.2f)))
		.SetUncheckedImage(IMAGE_BRUSH("MaterialDesignIcons/UnCheck", Icon24x24))
		.SetUncheckedHoveredImage(IMAGE_BRUSH("MaterialDesignIcons/UnCheck", Icon24x24, FLinearColor(0.5f, 0.5f, 0.5f)))
		.SetUncheckedPressedImage(IMAGE_BRUSH("MaterialDesignIcons/Uncheck", Icon24x24, FLinearColor(0.2f, 0.2f, 0.2f)))
		);

	Style->Set("TiledLevel.StopHereCheckBox",
		FCheckBoxStyle(DefaultCheckBoxStyle)
		.SetCheckedImage(IMAGE_BRUSH("MaterialDesignIcons/StopHere", Icon24x24))
		.SetCheckedHoveredImage(IMAGE_BRUSH("MaterialDesignIcons/StopHere", Icon24x24, FLinearColor(0.5f, 0.5f, 0.5f)))
		.SetCheckedPressedImage(IMAGE_BRUSH("MaterialDesignIcons/StopHere", Icon24x24, FLinearColor(0.2f, 0.2f, 0.2f)))
		.SetUncheckedImage(IMAGE_BRUSH("MaterialDesignIcons/NotStopHere", Icon24x24))
		.SetUncheckedHoveredImage(IMAGE_BRUSH("MaterialDesignIcons/NotStopHere", Icon24x24, FLinearColor(0.5f, 0.5f, 0.5f)))
		.SetUncheckedPressedImage(IMAGE_BRUSH("MaterialDesignIcons/NotStopHere", Icon24x24, FLinearColor(0.2f, 0.2f, 0.2f)))
		);


	Style->Set("TiledLevel.IncludeZCheckBox",
		FCheckBoxStyle(DefaultCheckBoxStyle)
		.SetCheckedImage(IMAGE_BRUSH("MaterialDesignIcons/IncludeZ", Icon24x24))
		.SetCheckedHoveredImage(IMAGE_BRUSH("MaterialDesignIcons/IncludeZ", Icon24x24, FLinearColor(0.5f, 0.5f, 0.5f)))
		.SetCheckedPressedImage(IMAGE_BRUSH("MaterialDesignIcons/IncludeZ", Icon24x24, FLinearColor(0.2f, 0.2f, 0.2f)))
		.SetUncheckedImage(IMAGE_BRUSH("MaterialDesignIcons/NotIncludeZ", Icon24x24))
		.SetUncheckedHoveredImage(IMAGE_BRUSH("MaterialDesignIcons/NotIncludeZ", Icon24x24, FLinearColor(0.5f, 0.5f, 0.5f)))
		.SetUncheckedPressedImage(IMAGE_BRUSH("MaterialDesignIcons/NotIncludeZ", Icon24x24, FLinearColor(0.2f, 0.2f, 0.2f)))
		);
	
	Style->Set("TiledLevel.MirrorXCheckBox",
		FCheckBoxStyle(DefaultCheckBoxStyle)
		.SetCheckedImage(IMAGE_BRUSH("MaterialDesignIcons/MirrorX", Icon24x24))
		.SetCheckedHoveredImage(IMAGE_BRUSH("MaterialDesignIcons/MirrorX", Icon24x24, FLinearColor(0.5f, 0.5f, 0.5f)))
		.SetCheckedPressedImage(IMAGE_BRUSH("MaterialDesignIcons/MirrorX", Icon24x24, FLinearColor(0.2f, 0.2f, 0.2f)))
		.SetUncheckedImage(IMAGE_BRUSH("MaterialDesignIcons/NotMirrorX", Icon24x24))
		.SetUncheckedHoveredImage(IMAGE_BRUSH("MaterialDesignIcons/NotMirrorX", Icon24x24, FLinearColor(0.5f, 0.5f, 0.5f)))
		.SetUncheckedPressedImage(IMAGE_BRUSH("MaterialDesignIcons/NotMirrorX", Icon24x24, FLinearColor(0.2f, 0.2f, 0.2f)))
		);
	
	Style->Set("TiledLevel.MirrorYCheckBox",
		FCheckBoxStyle(DefaultCheckBoxStyle)
		.SetCheckedImage(IMAGE_BRUSH("MaterialDesignIcons/MirrorY", Icon24x24))
		.SetCheckedHoveredImage(IMAGE_BRUSH("MaterialDesignIcons/MirrorY", Icon24x24, FLinearColor(0.5f, 0.5f, 0.5f)))
		.SetCheckedPressedImage(IMAGE_BRUSH("MaterialDesignIcons/MirrorY", Icon24x24, FLinearColor(0.2f, 0.2f, 0.2f)))
		.SetUncheckedImage(IMAGE_BRUSH("MaterialDesignIcons/NotMirrorY", Icon24x24))
		.SetUncheckedHoveredImage(IMAGE_BRUSH("MaterialDesignIcons/NotMirrorY", Icon24x24, FLinearColor(0.5f, 0.5f, 0.5f)))
		.SetUncheckedPressedImage(IMAGE_BRUSH("MaterialDesignIcons/NotMirrorY", Icon24x24, FLinearColor(0.2f, 0.2f, 0.2f)))
		);
	
	Style->Set("TiledLevel.MirrorZCheckBox",
		FCheckBoxStyle(DefaultCheckBoxStyle)
		.SetCheckedImage(IMAGE_BRUSH("MaterialDesignIcons/MirrorZ", Icon24x24))
		.SetCheckedHoveredImage(IMAGE_BRUSH("MaterialDesignIcons/MirrorZ", Icon24x24, FLinearColor(0.5f, 0.5f, 0.5f)))
		.SetCheckedPressedImage(IMAGE_BRUSH("MaterialDesignIcons/MirrorZ", Icon24x24, FLinearColor(0.2f, 0.2f, 0.2f)))
		.SetUncheckedImage(IMAGE_BRUSH("MaterialDesignIcons/NotMirrorZ", Icon24x24))
		.SetUncheckedHoveredImage(IMAGE_BRUSH("MaterialDesignIcons/NotMirrorZ", Icon24x24, FLinearColor(0.5f, 0.5f, 0.5f)))
		.SetUncheckedPressedImage(IMAGE_BRUSH("MaterialDesignIcons/NotMirrorZ", Icon24x24, FLinearColor(0.2f, 0.2f, 0.2f)))
		);


	Style->Set("TiledLevel.AutoRotateCheckBox",
		FCheckBoxStyle(DefaultCheckBoxStyle)
		.SetCheckedImage(IMAGE_BRUSH("MaterialDesignIcons/AutoRotate", Icon24x24))
		.SetCheckedHoveredImage(IMAGE_BRUSH("MaterialDesignIcons/AutoRotate", Icon24x24, FLinearColor(0.5f, 0.5f, 0.5f)))
		.SetCheckedPressedImage(IMAGE_BRUSH("MaterialDesignIcons/AutoRotate", Icon24x24, FLinearColor(0.2f, 0.2f, 0.2f)))
		.SetUncheckedImage(IMAGE_BRUSH("MaterialDesignIcons/NotAutoRotate", Icon24x24))
		.SetUncheckedHoveredImage(IMAGE_BRUSH("MaterialDesignIcons/NotAutoRotate", Icon24x24, FLinearColor(0.5f, 0.5f, 0.5f)))
		.SetUncheckedPressedImage(IMAGE_BRUSH("MaterialDesignIcons/NotAutoRotate", Icon24x24, FLinearColor(0.2f, 0.2f, 0.2f)))
		);
