...
// Level Editing	
	...
	UI_COMMAND(SelectEraserTool, "Eraser", "Eraser", EUserInterfaceActionType::RadioButton,FInputChord(EModifierKey::Shift, EKeys::B));
	...
	UI_COMMAND(ToggleAutoPaint, "Auto Paint", "Enale auto paint mode", EUserInterfaceActionType::ToggleButton, FInputChord());
	UI_COMMAND(RespawnAutoPaintInstances, "Respawn auto paint instances", "Respawn generated instances. Could result in different pattern due to randomness in your rules", EUserInterfaceActionType::Button, FInputChord(EModifierKey::Alt, EKeys::R));
	UI_COMMAND(ToggleAutoPaintItemHint, "Show auto paint hint", "Show the hint grids for where the auto paint was applied", EUserInterfaceActionType::ToggleButton, FInputChord(EModifierKey::Alt, EKeys::E));
	UI_COMMAND(ToggleEditViewMode, "Edit View Mode", "Toggle topdown or side edit view mode", EUserInterfaceActionType::ToggleButton, FInputChord());
	UI_COMMAND(CreateNewRuleItem, "Add item", "add new auto paint item", EUserInterfaceActionType::Button, FInputChord());
	UI_COMMAND(CreateNewRuleGroup, "Add group", "add new auto rule group", EUserInterfaceActionType::Button, FInputChord());
