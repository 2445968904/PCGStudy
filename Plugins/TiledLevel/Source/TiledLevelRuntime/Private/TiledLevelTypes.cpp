...
bool FTilePlacement::IsBlock() const
{
	return GetItem()->PlacedType == EPlacedType::Block;
}
...
int FEdgePlacement::GetLength() const
{
	return GetItem()->Extent.X;
}

bool FEdgePlacement::IsWall() const
{
	return GetItem()->PlacedType == EPlacedType::Wall;
}

// FString FEdgePlacement::ToString() const
// {
// 	return FString::Printf(TEXT("%s | lendth: %d"), *Edge.ToString(), GetLength());
// }

bool FPointPlacement::IsPillar() const
{
	return GetItem()->PlacedType == EPlacedType::Pillar;
}
