...
{
	// No need to check assets using this item...
...
UTiledItemSet* UTiledItemSet::CloneItemSet(UObject* Outer)
{
	return CastChecked<UTiledItemSet>(
		StaticDuplicateObject(this, Outer, NAME_None, EObjectFlags::RF_Transactional));
}
