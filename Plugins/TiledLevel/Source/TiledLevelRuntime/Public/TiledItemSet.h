...
public:
	...
	TObjectPtr<class UDataTable> CustomDataTable;
	...
	UTiledItemSet* CloneItemSet(UObject* Outer);

private:
	UPROPERTY()
	TArray<TObjectPtr<UTiledLevelItem>> ItemSet;
