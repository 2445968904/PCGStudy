...
void UMBMainScreen::EjectAllBindings()
{
	...
	if(SettingsBtn){SettingsBtn->OnClicked.RemoveAll(this);}
	if(LeartesBtn){LeartesBtn->OnClicked.RemoveAll(this);}
