...
protected:
	...
	virtual const FSlateBrush* GetBorderImage() const { return BorderImageAttribute.Get(); }
	FSlateColor GetBorderBackgroundColor() const { return BorderBackgroundColorAttribute.Get(); }
	virtual FVector2D GetDesiredSizeScale() const { return DesiredSizeScaleAttribute.Get(); }
	virtual bool GetShowDisabledEffect() const { return ShowDisabledEffectAttribute.Get(); }
