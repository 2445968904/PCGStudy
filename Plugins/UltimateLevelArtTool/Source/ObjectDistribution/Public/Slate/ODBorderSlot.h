...
#include "ODBorderSlot.generated.h"
 ...
 */
UCLASS()
class OBJECTDISTRIBUTION_API UODBorderSlot : public UPanelSlot
{
...
public:
	...
	void BuildSlot(TSharedRef<SODAssetBorder> InBorder);
...
private:
	...
	TWeakPtr<SODAssetBorder> Border;
	
	friend UODAssetBorder;
